...
function load_style_script() {
    ...
    wp_enqueue_script('my-swiper', 'https://unpkg.com/swiper@8.0.0/swiper-bundle.min.js', array('jquery'), '8.0.0', true);
    ...
    if (is_product()) {
        // Air datepicker and styles
        wp_enqueue_style('air-datepicker-css', get_stylesheet_directory_uri() . '/air-datepicker/air-datepicker.css', array(), '3.3.0');
        wp_enqueue_script('air-datepicker-js', get_stylesheet_directory_uri() . '/air-datepicker/air-datepicker.js', array('jquery'), '3.3.0', true);
        wp_enqueue_script('fallback-calendar-js', get_stylesheet_directory_uri() . '/js/vendor/fallback-calendar.js', array('jquery'), '1.0.0', true);
        
        // Price calculator script
        wp_enqueue_script('mitnafun-price-calculator', get_stylesheet_directory_uri() . '/js/modules/price-calculator.js', array('jquery'), '1.0.0', true);
        
        // Product rental script
        wp_enqueue_script('product-rental-js', get_stylesheet_directory_uri() . '/js/modules/product-rental.js', array('jquery', 'air-datepicker-js', 'fallback-calendar-js'), '1.0.0', true);
        ...
        // Only try to get ACF field if the function exists
        ...
        // Localize scripts for rental functionality
        wp_localize_script('product-rental-js', 'mitnafun_vars', array(
    ...
    if (is_front_page() || is_home()) {
        // Vendor scripts needed for home page
        wp_enqueue_script('owl-carousel', get_stylesheet_directory_uri() . '/js/vendor/owl.carousel.js', array('jquery'), '2.3.4', true);
        wp_enqueue_script('jquery-sticky', get_stylesheet_directory_uri() . '/js/vendor/jquery.sticky.js', array('jquery'), '1.0.4', true);
        
        // Home page main script
        wp_enqueue_script('mitnafun-home', get_stylesheet_directory_uri() . '/js/modules/home.js', array('jquery', 'owl-carousel', 'jquery-sticky'), '1.0.0', true);
    }
}
...
// Add localization directly in the main function instead
// The script localization is now handled in the load_style_script function
// We've removed this duplicate hook to avoid script loading conflicts
